...
friend parRecta eqRecta(Punto p1, Punto p2, parRecta par);	
...
struct parRecta recta; //Declaro variable de tipo recta
	p.escribirPunto();
	p1.escribirPunto();
	...
	p1.asignarPunto(1.0, 2.0, 0.0);
	p2.asignarPunto(2.0, 1.0, 0.0); //Asignamos los puntos que nesecitamos
