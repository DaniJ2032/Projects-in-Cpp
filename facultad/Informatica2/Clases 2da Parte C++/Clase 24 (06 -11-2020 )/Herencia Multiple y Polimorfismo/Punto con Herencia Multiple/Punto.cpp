...
void Triangulo::area()
{
	...
	altura = sqrt(((largo * largo) - (largo * largo)/4.0));
	at = largo * altura / 2.0;
	t = "Equilatero";	
...
/************************************************************************************************************/
/*Constructores y metodos para la clase Cuadrado*/ 
/*   											*/
/************************************************/
...
Cuadrado::Cuadrado(float _largo, float _angulo, float _area, float _perimetro, string _t):Segmento( _largo, _angulo) //Le digo que los dos primeros estan en la super class
{

	ac = _area;
	pc = _perimetro; //Cargo valores metidos por el usuario
	tc = _t;	
...
void Cuadrado::area()
{
 ...
 void Cuadrado::area(float _largo)
{
...
/**************************************************************************************************************/
/**************************Declaracion de contrusctores, metodos, etc de la clase tetrahedro*******************/
/*  																										//
 * *************************************************************************************************************/
...
Tetrahedro::Tetrahedro(float _largo, float _angulo, float _a , float _p , string _t, float _ath, float _vth):Triangulo( _largo, _angulo, _a, _p, _t)
{
...
void Tetrahedro::area()
{

	Triangulo::area(); 		
//	ath = 4 * Triangulo::obtenerAt();	//para private en class Triangulo
	//ath = 4 * obtenerAt();
	ath = (4 * at); //Como protected en class Triangulo
	
}		

void Tetrahedro::volumen()
{		

vth = (largo*largo*largo)*1.4142/12.0;		

}
/****************************************************************************************************************/

/***************************************************************************************************************/
/*Contructores y metodos de la clase Piramide */
/*                                            */
/**********************************************/
...
Piramide::Piramide()
{
 ...
 ap = 0.0;
 vp = 0.0;
 tp = "Iicialize un objeto y coloque el tipo de Piramide";
...
//Metodos
void Piramide::area()//Es el area del cuadrado mas cuatro veces el area del triangulo 
{

	Triangulo::area();
	Cuadrado::area();

	ap = ((4*Triangulo::obtenerAt()) + Cuadrado::obtenerA() );

	tp = "Piramide de base Cuadrangular regular y sus caras son Triangulos Equilateros";
